...
public class StopTimes extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		adapter = new SimpleAdapter(StopTimes.this,
       		 ...
       		 new String[] { BusDb.CROSSING_TIME, BusDb.ROUTE_NUMBER, BusDb.SHORT_DIRECTION_NAME, BusDb.ROUTE_NAME, BusDb.DESTINATION, BusDb.RAW_TIME },
       		 new int[] { R.id.crossing_time, R.id.route_number, R.id.route_short_direction, R.id.route_long_name, R.id.destination, R.id.raw_crossing_time });
